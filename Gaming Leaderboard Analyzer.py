...
print()
print('Dataset info:')
# FIXED: Added parentheses to call the info() method correctly
full_df.info()  # Added parentheses to actually print the info summary
...
print(clean_df.to_string())  # Printing the dataframe directly or using .to_string()
print()
print('Missing values filled with 0 (fillna):')
filled_df = full_df.fillna(0)
print(filled_df.to_string())  # Printing the dataframe directly or using .to_string()
